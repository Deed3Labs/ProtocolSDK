...
export interface IDeedNFTInterface extends ethers.Interface {
  functions: {
    ...
    getTraitValue(tokenId: ethers.BigNumberish, traitKey: string): Promise<string>;
    
    getTraitValues(tokenId: ethers.BigNumberish): Promise<string[]>;
    
    getTraitKeys(tokenId: ethers.BigNumberish): Promise<string[]>;
    
    getTraitName(traitKey: string): Promise<string>;
    ...
    getValidationStatus(tokenId: ethers.BigNumberish): Promise<boolean>;
